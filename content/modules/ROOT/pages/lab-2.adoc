...
We will start off doing a classic, which is learning what to NOT do: using the command module directly to make modification. 
IMPORTANT: The main reason why we cover it, is so that you may see it's limitations on full display. 
